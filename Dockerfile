...
RUN R -e "install.packages('https://r.docker.stat.auckland.ac.nz/src/contrib/iNZightPlots_2.10.2.tar.gz', repos = NULL, type = 'source', dependencies = TRUE)" \
&& R -e "install.packages('ggmosaic', repos = 'https://cran.r-project.org', type = 'source', dependencies = TRUE)" \
